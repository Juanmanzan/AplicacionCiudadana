...
document.addEventListener('DOMContentLoaded', () => {
  ...
  modalEl.addEventListener('show.bs.modal', (event) => {
    ...
    const origenRaw = (btn.dataset.origen || 'REPORTE').toUpperCase();
    const origenLabel = (origenRaw === 'ALERTA') ? 'ALERTA (usuario)' : 'REPORTE';
    ...
    const elOrigen = document.getElementById('m_origen');
    ...
    if (elOrigen) elOrigen.textContent = 'Origen: ' + origenLabel;
