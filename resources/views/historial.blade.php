        ...
        <div class="row g-3">
          ...
          <div class="col-12 col-md-3">
            ...
            <select name="genero" class="form-select">
              ...
              <option value="F" {{ ($filters['genero'] ?? null) === 'F' ? 'selected' : '' }}>Femenino</option>
              <option value="M" {{ ($filters['genero'] ?? null) === 'M' ? 'selected' : '' }}>Masculino</option>
            </select>
          </div>
        ...
        <table class="table align-middle mb-0">
          ...
          @forelse($rows as $r)
            @php
              ...
              $generoTxt = ($r->genero === 'F') ? 'Femenino' : (($r->genero === 'M') ? 'Masculino' : 'N/D');
